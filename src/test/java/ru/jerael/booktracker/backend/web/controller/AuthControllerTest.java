...
class AuthControllerTest {
    ...
    @Test
    void confirmRegistration_WhenRequestIsValid_ShouldReturnTokens() {
    ...
    @Test
    void login_WhenRequestIsValid_ShouldReturnTokens() {
        LoginRequest request = new LoginRequest(email, password);
        TokenPair tokenPair = new TokenPair(accessToken, refreshToken);
        when(loginUserUseCase.execute(any(UserLogin.class))).thenReturn(tokenPair);
